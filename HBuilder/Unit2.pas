...
begin
 ...
 with ActStyle do
 result:=(LineHeight=EmptyStr) and (Visibility=Low(TCSSVisibility)) and (Display=Low(TCSSDisplay)) and (ContentBefore=EmptyStr) and (ContentAfter=EmptyStr) and (Other=EmptyStr) and (HTMLAttributes=EmptyStr);
end;
