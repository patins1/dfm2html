...
type
  TTntCustomFileRun = TCustomFileRun;                                            
  TTntFileRun = TFileRun;                                                        
  TTntRichEditAction = TRichEditAction;                                          
  TTntRichEditBold = TRichEditBold;                                              
  TTntRichEditItalic = TRichEditItalic;                                          
  TTntRichEditUnderline = TRichEditUnderline;                                    
  TTntRichEditStrikeOut = TRichEditStrikeOut;                                    
  TTntRichEditBullets = TRichEditBullets;                                        
  TTntRichEditAlignLeft = TRichEditAlignLeft;                                    
  TTntRichEditAlignRight = TRichEditAlignRight;
  TTntRichEditAlignCenter = TRichEditAlignCenter;                                
  TTntTabAction = TTabAction;                                                    
  TTntPreviousTab = TPreviousTab;                                                
  TTntNextTab = TNextTab;                                                        
  TTntOpenPicture = TOpenPicture;                                                
  TTntSavePicture = TSavePicture;                                                
  TTntURLAction = TURLAction;                                                    
  TTntBrowseURL = TBrowseURL;                                                    
  TTntDownLoadURL = TDownLoadURL;                                                
  TTntSendMail = TSendMail;                                                      
  TTntListControlAction = TListControlAction;                                    
  TTntListControlCopySelection = TListControlCopySelection;                      
  TTntListControlDeleteSelection = TListControlDeleteSelection;                  
  TTntListControlSelectAll = TListControlSelectAll;                              
  TTntListControlClearSelection = TListControlClearSelection;
  TTntListControlMoveSelection = TListControlMoveSelection;
