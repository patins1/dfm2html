...
function FastCharPosTil(const aSource : String; const C: Char; StartPos,L : Integer) : Integer;//!!
...
//function FastPosBackTil(const aSourceString, aFindString : String; const aSourceLen, aFindLen, StartPos : Integer; EndPos:integer) : Integer;//!!
function FastPosBackTil(const aSourceString: String; aFindString : PChar; const aSourceLen, aFindLen, StartPos: Integer; EndPos:integer) : Integer;//!!
...
begin
  ...
  findlen:=SourceLen-(EndPos-1);//!!
  if findlen<0 then
  assert((EndPos>=0) and (StartPos>=0));
