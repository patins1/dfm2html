...
var
  Win32PlatformIsUnicode: Boolean = true;
  Win32PlatformIsXP: Boolean;
  Win32PlatformIs2003: Boolean;
  Win32PlatformIsVista: Boolean;

  WideIncludeTrailingPathDelimiter: function (const S: String): String = IncludeTrailingPathDelimiter;
  WideExcludeTrailingPathDelimiter: function (const S: String): String = ExcludeTrailingPathDelimiter;
  WideExtractFileDrive: function (const S: String): String = ExtractFileDrive;
  WideExtractFilePath: function (const S: String): String = ExtractFilePath;
  WideExtractFileExt: function (const S: String): String = ExtractFileExt;
  WideExtractFileName: function (const S: String): String = ExtractFileName;
  WideExtractFileDir: function (const S: String): String = ExtractFileDir;
  WideDirectoryExists: function (const S: String): Boolean = DirectoryExists;
  WideFileExists: function (const S: String): Boolean = FileExists;
  WideForceDirectories: function (S: String): Boolean = ForceDirectories;
  WideDeleteFile: function(const FileName: string): Boolean = SysUtils.DeleteFile;
  WideRemoveDir: function(const FileName: string): Boolean = SysUtils.RemoveDir;
  WideGetCurrentDir: function(): String = SysUtils.GetCurrentDir;
  WideSetCurrentDir: function(const Dir: String): Boolean = SetCurrentDir;
  WideExpandFileName: function(const S: String): String = ExpandFileName;
  WideParamStr: function(i: Integer): String = ParamStr;
  WideCopyFile: function(FromFile, ToFile: PWideChar; FailIfExists: LongBool): LongBool stdcall = CopyFile;
  WideCreateDir: function(const Dir: String): Boolean = CreateDir;
  WideChangeFileExt: function(const FileName, Extension: String): String = ChangeFileExt;
  WideExtractRelativePath: function(const BaseName, DestName: String): String = ExtractRelativePath;

  TntTryStrToDateTime: function (const Str: String; out DateTime: TDateTime): Boolean = TryStrToDateTime;
  TntTryStrToDate: function(const Str: String; out DateTime: TDateTime): Boolean = TryStrToDate;
  TntTryStrToTime: function(const Str: String; out DateTime: TDateTime): Boolean = TryStrToTime;

  TntStrToDateTime: function(const Str: String): TDateTime = StrToDateTime;
  TntStrToDate: function(const Str: String): TDateTime = StrToDate;
  TntStrToTime: function(const Str: String): TDateTime = StrToTime;

  TntStrToDateTimeDef: function(const Str: String; const Default: TDateTime): TDateTime = StrToDateTimeDef;
  TntStrToDateDef: function(const Str: String; const Default: TDateTime): TDateTime = StrToDateDef;

  TntStrToTimeDef: function(const Str: String; const Default: TDateTime): TDateTime = StrToTimeDef;
...
function WideSafeLoadLibrary(const Filename: Widestring; ErrorMode: UINT = SEM_NOOPENFILEERRORBOX): HMODULE;
...
function WideTextPosEx(const SubStr, S: WideString; Offset: Integer = 1): Integer;
...
uses
  WideStrUtils, TntWideStrUtils, TntWindows;
...
function WideTextPosEx(const SubStr, S: WideString; Offset: Integer = 1): Integer;
begin
  //Result := PosEx(Tnt_WideUpperCase(SubStr), Tnt_WideUpperCase(S), Offset);
  Result := WidePosEx(Tnt_WideUpperCase(SubStr), Tnt_WideUpperCase(S), Offset);
end;
...
//function WideStringToGUID(const S: WideString): TGUID;
...
function WideStringToGUID(const S: WideString): TGUID;
begin
  if not Succeeded(CLSIDFromString(PWideChar(S), Result)) then
