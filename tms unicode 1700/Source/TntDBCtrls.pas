...
type
  TTntDBEdit = TDBEdit;
  TTntDBText = TDBText;
  TTntCustomDBComboBox = TDBComboBox;
  TTntDBComboBox = TDBComboBox;
  TTntDBCheckBox = TDBCheckBox;
  TTntDBRichEdit = TDBRichEdit;
  TTntDBMemo = TDBMemo;
  TTntDBRadioGroup = TDBRadioGroup;
  TTntDBLookupListBox = TDBLookupListBox;
  TTntDBLookupComboBox = TDBLookupComboBox;
