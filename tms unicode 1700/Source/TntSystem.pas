...
function WideStringToUTF8(const S: WideString): AnsiString; deprecated;
function UTF8ToWideString(const S: AnsiString): WideString; deprecated;

function WideLoadResString(ResStringRec: PResStringRec): string;
