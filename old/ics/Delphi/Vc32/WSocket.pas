...
{
Da sonst FCloseInvoked=TRUE bestehen bleibt beim nächsten connecten, und
dann evt. bei einem User-Abort kein TriggerSessionClosed wegen
FCloseInvoked=TRUE ausgelöst wird
}
{behoben:     FCloseInvoked:=false; wird nun in DnsLookup gesetzt}
{//°!° sonst HTTP-Redirection: OnSessionClosed doppelt}              FCloseInvoked := TRUE;
