object PageContainer31: TPageContainer31
  Left = -4
  Top = -23
  Caption = 'red-ornaments.dfm'
  ClientHeight = 776
  ClientWidth = 1680
  ...
  object index: TdhPage
    ...
    object Panel5: TdhPanel
      ...
      Height = 226
      ImageType = bitImage
      Style.BackgroundImage.Path = 'images-red-ornaments\Panel5_nm.jpg'
      Style.BackgroundImage.State = isAnalyzed
      Style.BackgroundImage.Width = 250
      Style.BackgroundImage.Height = 226
      AutoSizeXY = asNone
    end
    ...
    object Panel1: TdhPanel
      ...
      Width = 843
      Height = 34
      Style.BackgroundImage.Path = 'images-red-ornaments\Panel1_nm.jpg'
      Style.BackgroundImage.State = isAnalyzed
      Style.BackgroundImage.Width = 750
      Style.BackgroundImage.Height = 65
      AutoSizeXY = asNone
    end
  end
end
