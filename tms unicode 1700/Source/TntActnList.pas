...
uses
  ActnList, Menus, ComCtrls, StdActns, ExtActns, Buttons, StdCtrls, Controls;

type
  TTntActionList = TActionList;
  TTntCustomAction = TCustomAction;
  TTntAction = TAction;
  TTntMenuActionLink = TMenuActionLink;
  TTntListViewActionLink = TListViewActionLink;
  TTntComboBoxExActionLink = TComboBoxExActionLink;
  TTntSpeedButtonActionLink = TSpeedButtonActionLink;
  TTntBitBtnActionLink = TBitBtnActionLink;
  TTntToolButtonActionLink = TToolButtonActionLink;
  TTntButtonActionLink = TButtonActionLink;
  TTntWinControlActionLink = TWinControlActionLink;
  TTntControlActionLink = TControlActionLink;
