...
{TNT-WARN TTimeField}
  ...
  TTntWideStringField = TWideStringField;
...
uses
  TntSysUtils, SysUtils;

{ TTntDateTimeField }

procedure TTntDateTimeField.SetAsString(const Value: string);
begin
  if Value = '' then
    inherited
  else
...
procedure TTntDateField.SetAsString(const Value: string);
begin
  if Value = '' then
    inherited
  else
...
procedure TTntTimeField.SetAsString(const Value: string);
begin
  if Value = '' then
    inherited
  else
