...
type
  TTntDataSetAction = TDataSetAction;
  TTntDataSetFirst = TDataSetFirst;
  TTntDataSetPrior = TDataSetPrior;
  TTntDataSetNext = TDataSetNext;
  TTntDataSetLast = TDataSetLast;
  TTntDataSetInsert = TDataSetInsert;
  TTntDataSetDelete = TDataSetDelete;
  TTntDataSetEdit = TDataSetEdit;
  TTntDataSetPost = TDataSetPost;
  TTntDataSetCancel = TDataSetCancel;
  TTntDataSetRefresh = TDataSetRefresh;
