object PageContainer32: TPageContainer32
  Left = -4
  Top = -23
  Caption = 'red-stripes.dfm'
  ClientHeight = 776
  ClientWidth = 1680
  ...
  object index: TdhPage
    ...
    Style.MarginTop = '0'
    Style.MarginRight = '0'
    Style.BackgroundColor = 11254742
    AutoSizeXY = asNone
    Right = 0
    Bottom = 0
    UseIFrame = False
    ...
    object PageControl1: TdhPageControl
      ...
      object Page1: TdhPage
        ...
        object Label3: TdhLabel
          ...
          Text = 
            ...
            'ed on you Drive C in a folder named Programs.'#10'<br><br>'#10'This temp' +
            'late is generated under the licence of the Creative Commons.'#10'You' +
            ' are allowed to use the template and embedded pictures - but ple' +
            'ase do'#10'not remove the links in the footer of this template. If y' +
            'ou like to change the'#10'picture, you will find a giude in your DFM' +
            '2HTML installation files. The files'#10'are usually installed on you' +
            ' Drive C in a folder named Programs.'#10'<br><br>'
          Style.FontSize = '14'
        ...
        object Panel5: TdhPanel
          ...
          Width = 360
          Height = 24
          Style.BackgroundImage.Path = 'images-red-stripes\Panel5_nm.jpg'
          Style.BackgroundImage.State = isAnalyzed
          Style.BackgroundImage.Width = 500
          Style.BackgroundImage.Height = 62
          AutoSizeXY = asNone
        end
      end
      object Page2: TdhPage
        ...
        object Panel6: TdhPanel
          ...
          Width = 360
          Height = 24
          Style.BackgroundImage.Path = 'images-red-stripes\Panel6_nm.jpg'
          Style.BackgroundImage.State = isAnalyzed
          Style.BackgroundImage.Width = 500
          Style.BackgroundImage.Height = 62
          AutoSizeXY = asNone
        ...
        object Label7: TdhLabel
          ...
          Text = 
            ...
            'ou like to change the'#10'picture, you will find a giude in your DFM' +
            '2HTML installation files. The files'#10'are usually installed on you' +
            ' Drive C in a folder named Programs.'
          Style.FontSize = '14'
          Style.TextAlign = ctaJustify
          Style.Color = 200487
          AutoSizeXY = asY
      ...
      object Page3: TdhPage
        ...
        object Panel7: TdhPanel
          ...
          Width = 360
          Height = 24
          Style.BackgroundImage.Path = 'images-red-stripes\Panel7_nm.jpg'
          Style.BackgroundImage.State = isAnalyzed
          Style.BackgroundImage.Width = 500
          Style.BackgroundImage.Height = 62
          AutoSizeXY = asNone
      ...
      object Page4: TdhPage
        ...
        object Panel8: TdhPanel
          ...
          Width = 360
          Height = 24
          Style.BackgroundImage.Path = 'images-red-stripes\Panel8_nm.jpg'
          Style.BackgroundImage.State = isAnalyzed
          Style.BackgroundImage.Width = 500
          Style.BackgroundImage.Height = 62
          AutoSizeXY = asNone
    ...
    object Panel9: TdhPanel
      ...
      Style.BorderLeft.Style = cbsNone
      Style.BorderRight.Style = cbsNone
      Style.BackgroundImage.Path = 'images-red-stripes\Panel9_nm.jpg'
      Style.BackgroundImage.State = isAnalyzed
      Style.BackgroundImage.Width = 500
      Style.BackgroundImage.Height = 62
      Style.BackgroundColor = White
      ...
      object Panel3: TdhPanel
        ...
        Style.BorderLeft.Style = cbsNone
        Style.BorderRight.Style = cbsNone
        Style.BackgroundImage.Path = 'images-red-stripes\Panel3_nm.jpg'
        Style.BackgroundColor = White
        Use = Label2
        AutoSizeXY = asNone
    ...
    object Panel4: TdhPanel
      ...
      object Label5: TdhLabel
        ...
        Height = 180
        Text = 
          #10'<p><b>Contact me:</b></p>'#10'<p>Name<br>'#10'Street<br>'#10'City</p>'#10#10'<p>P' +
          'hone: 999 / 99 99 99 99<br>'#10'Fax: 999 / 99 99 99 99</p>'#10#10'<p>E-Mai' +
          'l: info@domain.de<br>'#10'Web: www.domain.de</p>'
        Style.FontSize = '12'
        Style.Color = 200487
        Style.FontWeight = cfwBold
        AutoSizeXY = asY
